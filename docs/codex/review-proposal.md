# Software Review Process Proposal

## Purpose

This proposal defines a review process for Archive Agentic that is as
...
1. Promote the document into the canonical `docs/` workflow set after the pilot
